...
const ImageSlider = ({ slides, interval = 4000 }) => {
            ...
            <div className="slide-content">
              <div className="slide-left">
                ...
                <div className="slide-buttons">
                  <button className="btn btn-primary">{slides[currentIndex].primaryBtn}</button>
                  <button className="btn btn-secondary">{slides[currentIndex].secondaryBtn}</button>
                </div>
              ...
              <div className="slide-right">
                <div className="slide-image">
                  <span className="image-placeholder">{slides[currentIndex].emoji}</span>
                </div>
              </div>
            </div>
          </motion.div>
